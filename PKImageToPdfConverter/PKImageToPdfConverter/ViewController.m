...
#define widthPDF 500
#define heightPDF 500
#define imagesCountForPDF 100

@interface ViewController ()<UICollectionViewDataSource, UICollectionViewDelegate,UIWebViewDelegate, UINavigationControllerDelegate>

@property (strong, nonatomic) NSMutableArray *assetsFetchResults;
